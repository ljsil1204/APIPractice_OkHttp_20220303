...
//                        변수에 담긴 토큰 값(String) 을 SharePreferences에 담아두자.
//                        로그인 성공시에는 감기만, 필요한 화면/클래스에서 꺼내서 사용.
...
//                        토스트 : UI 조작 => 백그라운드에서 UI를 건드리면, 위험동작으로 간주하고 앱을 강제 종료.
